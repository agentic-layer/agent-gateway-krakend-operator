...
* **Agent Runtime Operator**: Includes the required CRDs for Agent Gateways. See xref:agent-runtime-operator:agent-runtime:how-to-guides/install.adoc[Install the Agent Runtime Operator] for installation instructions.
