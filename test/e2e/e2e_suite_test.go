...
const operatorName = "agent-gateway-krakend-operator"
...
var (
	...
	projectImage = "example.com/agent-gateway-krakend-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting agent-gateway-krakend-operator integration test suite\n")
